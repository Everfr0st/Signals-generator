...
;====================================================================     
			...
			.EQU OFFSET = 0x4000	; Offset de acceso a memoria externa
...
TABLE4:		.DB			0, 11, 22, 33, 44, 55, 66, 78, 89, 100, 111, 122, 133, 144, 155, 166, 177, 188, 200, 211, 222, 233, 244, 255	; Diente Sierra
...
;====================================================================
; CONFIGURACIÓN DE PERIFÉRICOS: BUS DE DATOS
;====================================================================

			; Habilitar la interfaz de memoria externa (datos, direcciones, ALE, WR, RD)
			LDI      TEMP,1<<SRE                ; Habilitador
		    STS      XMCRA,TEMP

			; El ultimo bit - activar bus de datos y mantener ultimo valor
			LDI      TEMP, 1<<XMBK
		    STS      XMCRB,TEMP

			;Configuracion acceder a todo  Habilitar la parte significativa (los tres primeros bits)
		    LDI		 TEMP,0<<XMM2|0<<XMM1|0<<XMM0      ;Usar todo el puerto C como transmisor de direcciones
		    STS	   	 XMCRB,TEMP
...
InterrupcionT1:
			...
			STS			0x8FDD, TEMP1			; Escribirlo en una dirección (DIR >= 0x8000 activará el circuito)
